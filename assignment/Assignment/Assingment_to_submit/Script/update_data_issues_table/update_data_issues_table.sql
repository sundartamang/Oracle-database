...
begin
    ...
    update data_issues set ISSUE_STATUS = 'fixed', STATUS_UPDATE_DATE = SYSDATE where DATA_ERROR_CODE = 110;
    update data_issues set ISSUE_STATUS = 'fixed', STATUS_UPDATE_DATE = SYSDATE where DATA_ERROR_CODE = 111;
    update data_issues set ISSUE_STATUS = 'fixed', STATUS_UPDATE_DATE = SYSDATE where DATA_ERROR_CODE = 112;
end;
/
...
begin
    ...
    update data_issues set ISSUE_STATUS = 'fixed', STATUS_UPDATE_DATE = SYSDATE where DATA_ERROR_CODE = 8;
    update data_issues set ISSUE_STATUS = 'fixed', STATUS_UPDATE_DATE = SYSDATE where DATA_ERROR_CODE = 9;
    update data_issues set ISSUE_STATUS = 'fixed', STATUS_UPDATE_DATE = SYSDATE where DATA_ERROR_CODE = 10;
    update data_issues set ISSUE_STATUS = 'fixed', STATUS_UPDATE_DATE = SYSDATE where DATA_ERROR_CODE = 11;
    update data_issues set ISSUE_STATUS = 'fixed', STATUS_UPDATE_DATE = SYSDATE where DATA_ERROR_CODE = 12;
    update data_issues set ISSUE_STATUS = 'fixed', STATUS_UPDATE_DATE = SYSDATE where DATA_ERROR_CODE = 13;
end;
/
