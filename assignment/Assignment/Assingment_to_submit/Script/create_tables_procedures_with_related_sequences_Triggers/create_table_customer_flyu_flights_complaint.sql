...
ALTER TABLE complaint ADD CONSTRAINT fk1_complaint_to_flight FOREIGN KEY(the_year, the_month, the_day, flight_id_no) REFERENCES FlyU_flights(flight_the_year, the_month, the_day, flight_number);
