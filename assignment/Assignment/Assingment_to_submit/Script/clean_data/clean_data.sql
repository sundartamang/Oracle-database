...
begin 
    ...
    update bad_flight set DB_SOURCE = 'unknown' where DB_SOURCE is null;
    update bad_flight set CUSTOMER_ID = 0 where CUSTOMER_ID is null;
    update bad_flight set THE_YEAR = 2017 where THE_YEAR is null;
    update bad_flight set THE_MONTH = 1 where THE_MONTH is null;
    update bad_flight set THE_DAY = 1 where THE_DAY is null;
end;
/
...
begin 
    update bad_complaint set COMPLAINT_ID = 0 where COMPLAINT_ID is null;
    ...
    update bad_complaint set CUSTOMER_ID = 0 where CUSTOMER_ID is null;
    update bad_complaint set FLIGHT_NUMBER = 0 where FLIGHT_NUMBER is null;
    update bad_complaint set THE_YEAR = 2017 where THE_YEAR is null;
    update bad_complaint set THE_MONTH = 1 where THE_MONTH is null;
    update bad_complaint set THE_DAY = 1 where THE_DAY is null;
