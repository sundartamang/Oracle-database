...
CREATE TABLE fact_table(
	...
	fk2_flight_key	INTEGER NOT NULL,
	fk3_complaint_key	INTEGER NOT NULL,
	fk4_customer_key	INTEGER NOT NULL,
...
ALTER TABLE fact_table ADD CONSTRAINT fk2_fact_table_to_dim_flights FOREIGN KEY(fk2_flight_key) REFERENCES dim_flights(flight_key) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE fact_table ADD CONSTRAINT fk3_fact_table_to_dim_complaint FOREIGN KEY(fk3_complaint_key) REFERENCES dim_complaint(complaint_key) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE fact_table ADD CONSTRAINT fk4_fact_table_to_dim_customers FOREIGN KEY(fk4_customer_key) REFERENCES dim_customers(customer_key) ON DELETE RESTRICT ON UPDATE RESTRICT;
